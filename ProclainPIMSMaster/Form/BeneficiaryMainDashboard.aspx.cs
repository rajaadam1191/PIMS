...
{
    public class CESEmpDashboardContents
    {
    ...
    public partial class BeneficiaryMainDashboard : System.Web.UI.Page
    {
        ...
        public void SuggestionCounts()
        {
            ...
            spanAccepted.InnerHtml = Ds.Tables[0].Rows[0].ItemArray[1].ToString();
            spanRejected.InnerHtml = Ds.Tables[0].Rows[0].ItemArray[2].ToString();

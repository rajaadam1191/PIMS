<%@ Page Title="" Language="C#" MasterPageFile="~/ManagerMaster.Master" AutoEventWireup="true" CodeBehind="HODMainDashboard.aspx.cs" Inherits="ProclainPIMSMaster.Form.HODMainDashboard" %>
                                    ...
                                    <div class="layers bd bgc-white p-20 cardin">
                                        ...
                                        <div class="layer w-100">
                                            <div class="peers ai-sb fxw-nw">
                                                ...
                                                <div class="peer">
                                                    <span id="spanNotFeas" runat="server"  class="d-ib lh-0 va-m fw-600 bdrs-10em pX-15 pY-15 bgc-red-50 c-red-500"> </span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="layers bd bgc-white p-20 cardin">
                                        ...
                                        <div class="layer w-100">
                                            <div class="peers ai-sb fxw-nw">
                                                ...
                                                <div class="peer">
                                                    <span id="spanApproved" runat="server"  class="d-ib lh-0 va-m fw-600 bdrs-10em pX-15 pY-15 bgc-blue-50 c-blue-500"> </span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="masonry-item col-md-12 ">
                            ...
                            <asp:GridView ID="SuggestionGridView" CssClass="form-control noticedt reps" runat="server" Style="background-color: none!important; display: table; padding-left: 0px; padding-right: 0px; padding-top: 0px; padding-bottom: 0px; margin-bottom: 20px" BorderStyle="None" BorderWidth="1px" CellPadding="5" GridLines="Horizontal" CellSpacing="5" AutoGenerateColumns="false" OnRowDataBound="SuggestionGridView_RowDataBound">
                                <Columns>
                                    ...
                                    <%--<asp:BoundField DataField="IMPL_Name" HeaderText ="IMPL_Name" />--%>
